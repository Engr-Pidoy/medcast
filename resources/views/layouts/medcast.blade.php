    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 flex w-64 -translate-x-full flex-col bg-slate-900 text-slate-300 transition-transform duration-200 lg:static lg:translate-x-0">
            ...
            <nav class="flex-1 space-y-1 px-3 py-5">
                ...
                <a href="{{ route('capacity-risk') }}" class="sidebar-link {{ $nav === 'capacity-risk' ? 'active' : '' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition hover:bg-slate-800 hover:text-white">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M3 20h18M5 20V9l7-5 7 5v11M9 20v-6h6v6M8 10h.01M12 10h.01M16 10h.01"/></svg>
                    Capacity Risk
                </a>
